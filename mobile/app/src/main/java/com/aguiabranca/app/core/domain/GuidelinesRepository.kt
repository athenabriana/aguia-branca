...
interface GuidelinesRepository {
    ...
    suspend fun create(title: String, description: String, pillar: Pillar, authorId: String, authorName: String, campaign: String? = null): Outcome<String>
    suspend fun update(id: String, title: String, description: String, pillar: Pillar, campaign: String? = null): Outcome<Unit>
